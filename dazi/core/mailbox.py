...
from dazi.core.protocols import create_text_message, create_idle_notification
...
async def send_message_func(to: str, message: str, summary: str = "") -> str:
    ...
    from dazi.core._singletons import mailbox, team_manager, active_team_name, current_agent_name
...
async def check_inbox_func(unread_only: bool = True, limit: int = 20) -> str:
    ...
    from dazi.core._singletons import mailbox, active_team_name, current_agent_name
...
async def send_idle_notification(
    ...
    from dazi.core._singletons import mailbox, team_manager
