...
from dazi.core.protocols import create_idle_notification
from dazi.core.task_store import Task, TaskStatus, TaskStore
from dazi.core.teammate import TeammateHandle, TeammateRunner, TeammateStatus
...
def delegate_task(task: str, max_turns: int = 5, allowed_tools: list[str] | None = None) -> str:
    ...
    from dazi.core.filesystem import file_reader_tool, calculator_tool, shell_exec_tool
...
async def spawn_agent_func(
    ...
    from dazi.core._singletons import autonomous_teammate
